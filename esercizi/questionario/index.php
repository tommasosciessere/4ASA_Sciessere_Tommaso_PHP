...
<body style="background-color: #87ddee;">
<table>
    <center>
    <td>
    <center>
        <div style="background-color: 	#4d99ea; margin: 100px; border-radius: 15px;"><br>
...
<form action="./accesso_pagina_benvenuto.php">
        ...
        <label for="Età">Inserire età: </label>
        <input type="number" id="Età" name="Età"><br><br>
        <label for="Sport">Inserire sport preferito: </label>
        <input type="text" id="Sport" name="Sport"><br><br>
        <label for="Colore">Inserire colore interfaccia: </label>
        <input type="color" id="Colore" name="Colore"><br><br>
    ...
    <td style="width: 50%;">
    <video width="700" style="border-radius: 15px;" controls>
